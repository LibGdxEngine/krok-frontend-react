          ...
          {plans.map((plan, index) => {
            ...
            return (
              ...
              >
                ...
                {/* CTA Button */}
                <button
                  className={`w-full py-4 px-6 rounded-35 font-semibold text-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2 ${
                    plan.popular
